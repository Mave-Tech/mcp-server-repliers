...
inputs = {
  ...
  name                        = local.name
  alb_enabled                 = true
  domain_name                 = "mcp-repliers.maveai.co"
  internal                    = false
  ...
  hosted_zone_id              = "Z060141521PLGDEHYZZJK"
  lb_idle_timeout             = 180
  tags                        = local.tags
  cpu                         = "512"
  memory                      = "1024"
  ...
  common_environment_variables = [
    ...
    {
      name  = "BASE_URL"
      value = "http://production-mave-mcp-server-repliers:8080"
    },
    {
